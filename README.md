...
uv run python src/datafun_01_foundations/app_gracetulsi.py
```
...
1. Rename `app_gracetulsi.py` to reflect your name or alias.
...
2. Edit this README.md file to change the run command to call your file instead.
   Use CTRL+f to search for `app_gracetulsi.py` and replace all occurrences exactly.
